<?php
		/**
 * Classe que representa a tabela "Stv_push_notification" 
 */
class Stv_push_notification
{
	/**
	 * metodo construtor
	 */ 
	...
	private $titulo;
	private $texto;
	private $status_notificacao_interna;
	private $data_registro;
	private $ip_registro;
	private $usuario_registro;
	private $status;
	private $programacao_envio;
	private $data_hora_agendamento;
	...
	public function setStatus_notificacao_interna($status_notificacao_interna) {
		$this->status_notificacao_interna = $status_notificacao_interna;
	}
	public function getStatus_notificacao_interna() {
		return $this->status_notificacao_interna;
	}
	// -- data_registro
	...
	// -- programacao_envio
	public function setProgramacao_envio($programacao_envio) {
		$this->programacao_envio = $programacao_envio;
	}
	public function getProgramacao_envio() {
		return $this->programacao_envio;
	}
	// -- data_hora_agendamento
	public function setData_hora_agendamento($data_hora_agendamento) {
		$this->data_hora_agendamento = $data_hora_agendamento;
	}
	public function getData_hora_agendamento() {

<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Stv_noticias_exclusivas" 
 */
class Stv_noticias_exclusivasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Stv_noticias_exclusivas
	 */
	public function insert($obj) {
		...
		$sql = "insert into stv_noticias_exclusivas 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Stv_noticias_exclusivas
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update stv_noticias_exclusivas set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Stv_noticias_exclusivas
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from stv_noticias_exclusivas 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Stv_noticias_exclusivas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from stv_noticias_exclusivas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Stv_noticias_exclusivas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM stv_noticias_exclusivas WHERE Field = '".$coluna."'");

<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Stv_noticias_categorias" 
 */
class Stv_noticias_categoriasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Stv_noticias_categorias
	 */
	public function insert($obj) {
		...
		$sql = "insert into stv_noticias_categorias 
				(
				titulo,
				status
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Stv_noticias_categorias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update stv_noticias_categorias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Stv_noticias_categorias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from stv_noticias_categorias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Stv_noticias_categorias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from stv_noticias_categorias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Stv_noticias_categorias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM stv_noticias_categorias WHERE Field = '".$coluna."'");

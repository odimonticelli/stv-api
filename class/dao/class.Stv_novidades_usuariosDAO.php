<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Stv_novidades_usuarios" 
 */
class Stv_novidades_usuariosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Stv_novidades_usuarios
	 */
	public function insert($obj) {
		...
		$sql = "insert into stv_novidades_usuarios 
				(
				id_usuario,
				id_novidade
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Stv_novidades_usuarios
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update stv_novidades_usuarios set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Stv_novidades_usuarios
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from stv_novidades_usuarios 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Stv_novidades_usuarios conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from stv_novidades_usuarios $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Stv_novidades_usuarios
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM stv_novidades_usuarios WHERE Field = '".$coluna."'");
